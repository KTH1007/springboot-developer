...
@RestController // HTTP Responser Body에 객체 데이터를 JSON 형식으로 반환하는 컨트롤러
public class BlogApiController {
    ...
    // URL 경로에서 값 추출
    public ResponseEntity<ArticleResponse> findArticle(@PathVariable long id) {  // URL에서 id에 해당하는 값이 파라미터로 들어감
